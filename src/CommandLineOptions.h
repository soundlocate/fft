...
public:
	...
	unsigned int windowingFunction() {
		return args.windowingFunction;
	}
	...
	unsigned int fftPerSec() {
		return args.fftPerSec;
	}
...
private:
	...
	// "-f " + fftSize, "-s " + samplerate, "-r " + fftPerSec, "-w " + windowingFunction
